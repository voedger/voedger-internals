...
[^15]: `[~server.design.sequences/cmp.sequencer.Next~impl]` [pkg/isequencer/impl.go:169:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/impl.go#L169)
[^16]: `[~server.design.sequences/cmp.sequencer.Flush~impl]` [pkg/isequencer/impl.go:263:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/impl.go#L263)
[^17]: `[~server.design.sequences/cmp.sequencer.Actualize~impl]` [pkg/isequencer/impl.go:479:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/impl.go#L479)
...
[^20]: `[~server.design.sequences/cmp.ISeqStorageImplementation.i688~impl]` [pkg/appparts/internal/seqstorage/impl.go:101:impl](https://github.com/voedger/voedger/blob/main/pkg/appparts/internal/seqstorage/impl.go#L101)
[^21]: `[~server.design.sequences/cmp.VVMStorageAdapter~impl]` [pkg/vvm/storage/impl_seqstorage.go:15:impl](https://github.com/voedger/voedger/blob/main/pkg/vvm/storage/impl_seqstorage.go#L15)
...
[^23]: `[~server.design.sequences/test.isequencer.mockISeqStorage~impl]` [pkg/isequencer/types.go:106:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/types.go#L106)
[^24]: `[~server.design.sequences/test.isequencer.LongRecovery~impl]` [pkg/isequencer/isequencer_test.go:873:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/isequencer_test.go#L873)
[^25]: `[~server.design.sequences/test.isequencer.MultipleActualizes~impl]` [pkg/isequencer/isequencer_test.go:733:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/isequencer_test.go#L733)
[^26]: `[~server.design.sequences/test.isequencer.FlushPermanentlyFails~impl]` [pkg/isequencer/isequencer_test.go:803:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/isequencer_test.go#L803)
