...
[^15]: `[~server.design.sequences/cmp.sequencer.Next~impl]` [pkg/isequencer/impl.go:201:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/impl.go#L201)
[^16]: `[~server.design.sequences/cmp.sequencer.Flush~impl]` [pkg/isequencer/impl.go:290:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/impl.go#L290)
[^17]: `[~server.design.sequences/cmp.sequencer.Actualize~impl]` [pkg/isequencer/impl.go:450:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/impl.go#L450)
...
[^24]: `[~server.design.sequences/test.isequencer.LongRecovery~impl]` [pkg/isequencer/isequencer_test.go:874:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/isequencer_test.go#L874)
[^25]: `[~server.design.sequences/test.isequencer.MultipleActualizes~impl]` [pkg/isequencer/isequencer_test.go:734:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/isequencer_test.go#L734)
[^26]: `[~server.design.sequences/test.isequencer.FlushPermanentlyFails~impl]` [pkg/isequencer/isequencer_test.go:804:impl](https://github.com/voedger/voedger/blob/main/pkg/isequencer/isequencer_test.go#L804)
