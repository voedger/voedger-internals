...
[^20]: `[~server.design.orch/VVM.test.TTLStorageMem~impl]` [pkg/vvm/storage/impl_electionsbydrivers_test.go:27:impl](https://github.com/voedger/voedger/blob/main/pkg/vvm/storage/impl_electionsbydrivers_test.go#L27)
[^21]: `[~server.design.orch/VVM.test.TTLStorageCas~impl]` [pkg/vvm/storage/impl_electionsbydrivers_test.go:33:impl](https://github.com/voedger/voedger/blob/main/pkg/vvm/storage/impl_electionsbydrivers_test.go#L33)
[^22]: `[~server.design.orch/VVM.test.TTLStorageDyn~impl]` [pkg/vvm/storage/impl_electionsbydrivers_test.go:51:impl](https://github.com/voedger/voedger/blob/main/pkg/vvm/storage/impl_electionsbydrivers_test.go#L51)
[^23]: `[~server.design.orch/VVM.test.TTLStorageBbolt~impl]` [pkg/vvm/storage/impl_electionsbydrivers_test.go:43:impl](https://github.com/voedger/voedger/blob/main/pkg/vvm/storage/impl_electionsbydrivers_test.go#L43)
...
[^26]: `[~server.design.orch/ttlStorageMock~impl]` [pkg/ielections/impl_mockstorage.go:17:impl](https://github.com/voedger/voedger/blob/main/pkg/ielections/impl_mockstorage.go#L17)
