...
[^5]: `[~server.vsql.smallints/it.SmallIntegers~impl]` [pkg/parser/impl_test.go:2900:impl](https://github.com/voedger/voedger/blob/main/pkg/parser/impl_test.go#L2900)
