...
- Claude
  ...
  - Prompt: Prepare mermad flowchart diagram. Each goroutine shall be a separate subgraph. [The whole private chat](https://claude.ai/chat/3f7c98c6-bee3-4e57-a1b0-c9ee27dd02e4).
...
[^22]: `[~server.design.orch/VVM.test.TTLStorageDyn~impl]` [pkg/vvm/storage/impl_electionsbydrivers_test.go:52:impl](https://github.com/voedger/voedger/blob/main/pkg/vvm/storage/impl_electionsbydrivers_test.go#L52)
[^23]: `[~server.design.orch/VVM.test.TTLStorageBbolt~impl]` [pkg/vvm/storage/impl_electionsbydrivers_test.go:44:impl](https://github.com/voedger/voedger/blob/main/pkg/vvm/storage/impl_electionsbydrivers_test.go#L44)
